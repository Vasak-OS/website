...
> **Es una versión Beta.** Se instala y se usa, con las funciones completas, pero todavía quedan errores por pulir y puede haber cambios entre compilaciones. Antes de reemplazar tu sistema principal, revisá el [estado del proyecto](/state/).
